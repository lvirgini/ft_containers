...
incl_path2="../includes/ ../"
# incl_path="./../includes/*/*"
#  ../includes/iterator/ ../includes/map ../includes/vector ../includes/others ../includes/red_black_tree ../includes/stack"
...
compile () {
	...
	compile_cmd="$CC $CFLAGS -o ${3} -I ./$incl_path -I ../includes -I ../includes/stack -I ../includes/map -I ../includes/vector -I ../includes/others -I ../includes/iterator -I ../includes/red_black_tree -D ${macro_name} ${1}"
	if [ -n "$4" ]; then
		compile_cmd+=" &>${4}"
	fi
	eval "${compile_cmd}"
